...
func (o *PingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /kapis/server.license.kubesphere.io/v1alpha1/clusters/{cluster}/ping] Ping", response, response.Code())
	}
}
...
func (o *PingOK) Error() string {
	...
	return fmt.Sprintf("[GET /kapis/server.license.kubesphere.io/v1alpha1/clusters/{cluster}/ping][%d] pingOK %s", 200, payload)
}
