...
// WithCluster adds the cluster to the ping params
func (o *PingParams) WithCluster(cluster string) *PingParams {
	o.SetCluster(cluster)
	return o
}

// SetCluster adds the cluster to the ping params
func (o *PingParams) SetCluster(cluster string) {
	o.Cluster = cluster
}
