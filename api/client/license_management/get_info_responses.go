...
func (o *GetInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /kapis/server.license.kubesphere.io/v1alpha1/info] GetInfo", response, response.Code())
	}
}
...
type GetInfoOK struct {
	Payload *models.ModelsServerInformation
}
...
func (o *GetInfoOK) Error() string {
	...
	return fmt.Sprintf("[GET /kapis/server.license.kubesphere.io/v1alpha1/info][%d] getInfoOK %s", 200, payload)
}
